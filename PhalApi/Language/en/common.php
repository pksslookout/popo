...
return array(
    'Hi {name}, welcome to use PhalApi!' => 'Hi {name}, welcome to use PhalApi!',
    'user not exists' => 'user not exists',

    // Agent

    // Authorcenter
    '暂无视频列表' => 'Video List Not available',
    '该音乐已下架' => 'This music has been taken down',
    '取消收藏成功' => 'Uncollection successfu',
    ...
    '姓名长度在10个字内' => 'Name length within 10 characters',
    '手机号码不正确' => 'Incorrect mobile phone number',
    ...
    '地址删除成功' => 'Address deletion successful',
    '收货地址删除失败' => 'Delivery address deletion failed',
    '收货地址不能为空,无法删除' => 'Delivery address cannot be empty and cannot be deleted',
    '商品浏览记录添加成功' => 'Product Browsing record Added successfully',
    '商品不存在' => 'The product does not exist',
    '商品浏览记录删除成功' => 'Product Browsing record deletion successful',
    '商品浏览记录删除失败' => 'Failed to delete product browsing record',
    '订单提交成功' => 'Order Submission Successful',
    '订单生成失败' => 'Order Generation Failed',
    '余额支付' => 'Order awaiting Payment',
    '订单等待支付' => 'Order awaiting Payment',
    '订单不存在' => 'Order Does not exist',
    '订单已关闭' => 'Order Closed',
    '订单已支付' => 'Order Paid',
    '微信未配置' => 'Wechat Not configured',
    '支付' => 'Payment',
    '购买' => 'Purchase',
    '您的余额不足' => 'Your balance is insufficient',
    '使用余额支付订单失败' => 'Failed to pay order with balance',
    '订单余额支付成功' => 'Order balance payment successful',
    '缺少必要参数openid' => 'Missing necessary parameter openid',
    '微信小程序支付未配置' => 'Wechat Mini Program Payment Not configured',
    '收货地址不存在' => 'Delivery address does not exist',
    '不能购买自己的商品' => "Cannot purchase one's own goods",
    '该商品已下架' => 'Product has been taken off the shelves',
    '商品未通过审核' => 'Product not Approved',
    '没有对应的商品规格' => 'No corresponding product specification',
    '商品库存不足' => 'Insufficient inventory of goods',
    '留言内容在100字以内' => 'Message content within 100 characters',
    '主播不存在' => 'Streamer Does not exist',
    '主播未代售该商品' => 'The streamer did not sell this product',
    '分享商品用户不存在' => 'Share product user Does Not exist',
    '订单取消成功' => 'Order Cancellation Successful',
    '订单已付款,不可取消' => 'Order paid for, non-cancellable',
    '订单取消失败,请重试' => 'Order cancellation failed. Please try again',
    '确认收货成功' => 'Confirmed Receipt Successful',
    '订单已取消' => 'Order Cancelled',
    '等待卖家发货' => 'Waiting for the seller to ship',
    '订单已确认收货' => 'Order Confirmed Receipt',
    '订单申请退款中' => 'Order refund application in progress',
    '订单确认收货失败,请重试' => 'Order confirmation of receipt failed. Please try again',
    '订单不允许删除' => 'Order does not allow deletion',
    '订单已经删除' => 'Order Deleted',
    '评价内容在200字以内' => 'Evaluation content within 200 words',
    '评价图片最多上传5张' => 'Upload up to 5 evaluation pictures',
    '商品质量评分为0-5的整数' => 'Product quality score of integers 0 to 5',
    '服务态度评分为0-5的整数' => 'Service attitude score as an integer from 0 to 5',
    '送货服务评分为0-5的整数' => 'Delivery service score as an integer of 0 to 5',
    '请先对该订单付款' => 'Please make payment for this order first',
    '请先确认收货' => 'Please confirm receipt of goods first.',
    '该订单已经评价' => 'This order has been evaluated',
    '该订单为退款状态,不能评价' => 'This order is in a refund status and cannot be evaluated',
    '订单评价失败' => 'Order Evaluation Failed',
    '不可对该订单追评' => 'Cannot comment on this order',
    '追评失败,请重试' => 'Review failed, please try again',
    '申请退款成功' => 'Refund application successful',
    '请确认退货原因' => 'Please confirm the reason for the return.',
    '退款说明在300字以内' => 'Refund statement within 300 words',
    '订单退款取消成功' => 'Order Refund Cancellation Successful',
    '重新申请成功' => 'Re-application successful',
    '申请平台介入成功' => 'Application platform intervention successful',
    '原因描述应在300字以内' => 'The description of the cause should be within 300 words.',
    '申诉原因不存在' => 'Reasons for appeal do not exist',
    '你的商品“' => 'Your product“',
    '”收到一笔新订单,订单编号:' => '”Received a new order, order number :',
    '交易已关闭' => 'Transaction closed',
    '等待买家付款' => 'Waiting for buyer to make payment',
    '买家已付款' => 'Buyer has Paid',
    '卖家已发货' => 'Seller Has Shipped',
    '已收货' => 'Received',
    '已评价' => 'Evaluated',
    '申请退款中' => 'Refund Application in progress',
    '退款失败' => 'Refund Failed',
    '退款成功' => 'Refund Successful',
    '已到账' => 'Received',

    // Charge
    '购买{name}会员' => 'Purchase {name} membership',
    '订单信息有误，请重新提交' => 'The order information is incorrect, please resubmit',
    '充值{coin}虚拟币' => 'Recharge {coin} virtual currency',
    '会员特权'=>"Member",

    // Dynamic
    '视频分类不存在' => 'Video classification does not exist',
    '发布失败' => 'Publish Failed',
    '评论成功' => 'Comment Successful',
    '回复成功' => 'Reply successful',
    '操作成功' => 'Operation successful',
    '不能给自己点赞' => "Can't give myself a thumbs-up",
    '点赞成功' => 'Like successful',
    '评论信息不存在' => 'Comment Information does not exist',
    '话题标签已删除' => 'Topic tag deleted',
    '删除成功' => 'Delete successful',
    '举报成功' => 'Report successful',
    '暂无举报分类列表' => 'No list of Reported Categories',
    '动态信息错误,请稍后操作~' => 'Dynamic information error, please operate later ~',
    '您无权进行删除操作~' => 'You have no right to delete ~',
    '人参与了该话题' => 'People participated in this topic',
    ...
    // Game
    '押金不足{limit},无法上庄' => 'Deposit insufficient {limit}, unable to enter the market',
    ...
    // Linkmic
    '设置成功' => 'Set successful',
    '用户等级达到{mic_limit}级才可与主播连麦哦~' => 'Users must reach the {mic_limit} level to connect with the streamer!',
    '主播未开启连麦功能哦~' => 'The host has not enabled the live connection function yet ~',
    '混流失败' => 'Mixed flow failure',
    ...
    // Live
    '已被禁播' => 'Has been banned',
    '发布视频数量未达标' => 'The number of posted videos has not reached the target',
    '粉丝数量未达标' => 'Number of followers not reaching the target',
    '等级小于{level_limit}级，不能直播' => 'Level less than {level_limit} cannot be live-streamed',
    '密码不能为空' => 'Password cannot be empty',
    '图片仅能上传 jpg,png,jpeg' => 'Images can only be uploaded in jpg,png, and jpeg formats',
    '吕布' => 'Lu Bu',
    '你的好友：{user_nicename}正在直播，邀请你一起' => 'Your friend: {user_nicename} is live streaming and invites you to join',
    '成功' => 'Success',
    '余额不足' => 'Insufficient balance',
    '该礼物是年守护专属礼物奥~' => "This gift is an exclusive gift for the New Year's Guardian!",
    '账号长度不能超过200个字符' => 'The account length cannot exceed 200 characters.',
    'token已过期，请重新登陆' => 'token has expired. Please log in again',
    '无权操作' => 'Unauthorized operation',
    '关闭成功' => 'Close successful',
    '上热门成功' => 'Success in going viral',
    '有未使用的订单' => 'Unused orders',
    '获取成功' => 'Achieve success',
    '本房间为计时房间，每分钟需支付' => 'This room is a time-based room. Payment is required per minute.',
    '解除成功' => 'Successful release',
    '您不是该直播间的管理员，无权操作' => 'You are not the administrator of this live streaming room and have no right to operate it.',
    ...
    '邮箱地址无效' => 'The email address is invalid',
    '该邮箱已注销' => 'This email address has been cancelled',
    '账号不一致' => 'The accounts are inconsistent',
    '验证码错误次数5，明日再试' => 'The verification code error count is 5. Try again tomorrow',
    '手机号码不一致' => 'Inconsistent mobile phone numbers',
    '验证码错误' => 'Verification Code error',
    '密码为6-20位字母数字组合' => 'Password: 6-20 alphanumeric combination',
    ...
    '您已当日发送次数过多' => 'You have sent too many times on the same day',
    ...
    // Newmessage
    '信息不存在！' => "Information doesn't exist!",

    // Official

    // Paidprogram
    '您的申请被拒,{payment_time}日后可再次申请,如有疑问可咨询平台客服' => "Your application has been rejected. {payment_time} you can reapply in the future. If you have any questions, please consult the platform's customer service.",
    '作品标题在15字以内' => 'Work title within 15 characters',
    '内容简介在100字以内' => 'The content summary should be within 100 words.',
    '作者简介在50字以内' => "Author's Profile within 50 words",
    '填写作品价格在1-10000之间' => 'Fill in the work price between 1 and 10,000',
    '花费' => 'Cost',
    '评价等级应在1-5级之间' => 'The evaluation grade should be between 1 and 5.',
    '共1集' => '1 episode in total',
    '共' => 'Common',
    '集' => 'Set',
    ...
    // Red
    '红包名称最多20个字' => 'Red envelope name up to 20 characters',
    ...
    // Seller
    '店铺正在审核中' => 'Store under review',
    '商品名称不能超过15字' => 'Product name cannot exceed 15 characters',
    '商品详情不能超过300字' => 'Product details cannot exceed 300 words',
    '商品规格名称应在15个字符以内' => 'The name of the product specification should be within 15 characters.',
    '商品规格库存在1-9999999之间' => 'The product specification inventory is between 1 and 9,999,999',
    '商品规格单价在1-99999999之间' => 'The unit price of the product specification is between 1 and 99,999,999',
    '商品运费在0-99999之间' => 'The shipping cost of the goods is between 0 and 99,999',
    '请填写姓名' => 'Please fill in your name',
    '姓名长度不能超过20个字' => 'The length of the name cannot exceed 20 characters',
    '请选择所在省份' => 'Please select your province',
    '请选择所在地区' => 'Please select your region',
    '商品下架,无法修改规格' => 'Product removed from shelves, specifications cannot be modified',
    '商品规格更新失败' => 'Product Specification update failed',
    '商品规格单价在1-99999之间' => 'The unit price of the product specification is between 1 and 99,999',
    '商品运费在0-999之间' => 'The shipping cost of the goods is between 0 and 999',
    '订单发货失败,请重试' => 'Order shipment failed. Please try again',
    '订单删除成功' => 'Order deletion Successful',
    '待发货' => 'Pending Shipment',
    '已发货' => 'Shipped',
    '已签收' => 'Signed for',
    '商品钱款已发放到您的账户中' => 'The payment for the goods has been credited to your account',
    '订单未申请退款' => 'Order Not applied for refund',
    '还剩' => 'Left',
    '买家重新申请退款' => 'Buyer Re-applies for refund',
    '您已经拒绝了买家退款申请{shop_process_num}次' => "You have rejected the buyer's refund application {shop_process_num} times",
    '等待平台处理中' => 'Waiting for platform processing',
    '拒绝详细原因应在300字以内' => 'The detailed reason for rejection should be within 300 words',
    '您已经拒绝{shop_process_num}次,不能再操作' => 'You have rejected {shop_process_num} times and cannot operate anymore',
    '你的商品“{goods_name}”卖家已经同意退款' => "The seller of your product' {goods_name} has agreed to a refund",
    '你的商品“{goods_name}”卖家拒绝退款' => "Your product '{goods_name}' seller refuses refund",
    '商品名称必须在20字以内' => 'The product name must be within 20 characters',
    '商品原价必须在0-99999999之间' => 'The original price of the product must be between 0 and 99999999',
    '商品现价必须在0-99999999之间' => 'The current price of the commodity must be between 0 and 99999999',
    '商品简介必须在50字以内' => 'The product description must be within 50 words',
    '商品已下架' => 'Product has been taken off the shelves',
    ...
    '请先进行实名认证' => 'Please complete real-name authentication first',
    '请填写身份证号' => 'Please enter your ID number',
    '身份证号不合法' => 'Id number Illegal',
    '经营者联系人不能超过20个字' => 'The contact person of the business operator cannot exceed 20 characters',
    '详细地址必须在50字以内' => 'The detailed address must be within 50 characters',
    '收货人姓名长度不能超过20个字' => "The length of the consignee's name cannot exceed 20 characters",
    '店铺审核中,请耐心等待' => 'Store review in progress. Please wait patiently',
    '管理员正在飞速审核中，请耐心等待~' => 'The administrator is conducting a rapid review. Please be patient and wait',
    '管理员正在飞速审核中，请勿重新提交~' => 'The administrator is rapidly reviewing. Please do not resubmit ~',
    '系统繁忙，请稍后操作~' => 'System busy, please operate later ~',
    '操作失败' => 'Operation failed',
    '小店' => 'Small Store',
    '的小店' => 'the small store of ',
    '天后评论' => 'diva comments',
    ...
    // Upload
    '无指定存储方式' => 'No specified storage method',

    // User
    '直播小店' => 'Live Streaming Store',
    '我的收藏' => 'My Collection',
    '充值' => 'Charge',
    '回复了您的评论' => 'I replied to your comment',
    '收礼物' => 'Receive the gift',
    '分销收益' => 'Installment sales revenue',
    '您的认证没有通过，请重新认证，原因：' => 'Your verification has not been passed. Please re-verify. Reason:',
    '家族长收益' => 'Family head income',
    '资料提交成功，审核中' => 'The materials have been submitted successfully and are under review',
    '房间收费' => 'D-double occupancy',
    '计时收费' => 'Time-based fare',
    '守护' => 'Guard',
    '每观看60秒视频奖励' => 'A reward is given for every 60 seconds of video watched',
    '我的钱包' => 'My Wallet',
    '我的收益' => 'My earnings',
    '我的小店' => 'My Little Shop',
    '上热门列表' => 'On the Hot List',
    '创作者中心' => 'Creator Center',
    '红包收益' => 'Red envelope Earnings',
    '直播动态' => 'Live Stream Updates',
    '直播权限说明' => 'Live Streaming Permission Description',
    '邀请赚钱' => 'Invite to Earn Money',
    '观看记录' => 'Viewing Record',
    '广告管理' => 'Advertising Management',
    '个性设置' => 'Personality Settings',
    '请选择上传文件' => 'Please select Upload File',
    '更换失败，请稍候重试' => 'Replacement failed. Please try again later',
    '昵称重复，请修改' => 'Nickname repeated, please modify',
    '输入非法，请重新输入' => 'Input illegal, please re-enter',
    '修改失败' => 'Modification Failed',
    '支付宝支付' => 'Alipay Payment',
    '微信支付' => 'Wechat Pay',
    '苹果支付' => 'Apple Pay',
    '这里什么都有' => 'Everything is here',
    '获取语言不存在' => 'Get language does not exist',
    '收藏好物' => 'Collectible Items',
    '{name_coin}可通过平台提供的支付方式进行充值获得，{name_coin}适用于平台内所有消费；{name_score}可通过直播间内游戏奖励获得，所得{name_score}可用于平台商城内兑换会员、坐 骑、靓号等服务，不可提现。，' => "{name_coin} can be recharged and obtained through the payment methods provided by the platform. {name_coin} is applicable to all consumption within the platform. {name_score} can be obtained through in-game rewards in the live stream. The obtained {name_score} can be used to exchange for services such as membership, rides, and attractive numbers in the platform's mall, but it cannot be withdrawn.",
    '你的余额不足' => 'Your balance is insufficient',
    '扣费失败' => 'Deduction failed',
    '失败，请重试' => 'Failed, please try again',
    '支付成功' => 'Payment successful',
    '提现最低额度为{cash_min}元' => 'The minimum withdrawal amount is {cash_min} yuan',
    '每月只可提现{cash_max_times}次,已达上限' => 'Only {cash_max_times} can be withdrawn each month, reaching the limit',
    '用户不存在' => 'User Does Not exist',
    '最多只能选择3个印象' => 'Only 3 impressions can be selected at most',
    '黑名单' => 'Blacklist',
    ...
    '账号长度不能超过40个字符' => 'Account length cannot exceed 40 characters',
    '提现最低额度为{balance_cash_min}元' => 'Minimum withdrawal amount is {balance_cash_min} yuan',
    '每月只可提现{balance_cash_max_times}次,已达上限' => 'Only {balance_cash_max_times} can be withdrawn each month, reaching the limit',
    '温馨提示：当您某个任务达成时就会获得平台奖励给您的{name_coin}，获得的奖励需要您手动领取才可放入余额中，当日不领取次日系统会自动清零，亲爱的您一定要记得领取当日奖励哦~' => 'Warm reminder: When you complete a certain task, you will receive {name_coin} as a reward from the platform. The reward you obtain needs to be claimed manually before it can be placed in your balance. If you do not claim it on the same day, the system will automatically reset it to zero the next day. Dear you, please remember to claim the reward of the day!',
    '当前用户是会员' => 'Current User is a member',
    '当前用户不是会员！' => 'The current user is not a member!',
    '获取失败！' => 'Failed to get!',
    '举报类型不存在！' => 'report type does not exist!',
    '切换成功' => 'Switch successful',
    '新密码长度必须为4位' => 'New password length must be 4 characters',
    '每月{cash_start}-{cash_end}号可进行提现申请，每月只可提现{cash_max_times}次' => 'Withdrawal applications can be made on the {cash_start}-{cash_end} number each month. Withdrawals can only be made on the {cash_max_times} number each month. You can only withdraw {cash_max_times} times per month',
    '每月{cash_start}-{cash_end}号可进行提现申请' => 'Withdrawal application can be made on the {cash_start}-{cash_end} number every month',
    '未开播' => 'Not aired',
    '的评论中@了你' => 'I @ed you in the comments of',
    '评论了您的作品' => 'Commented on your work',
    '观看直播时长达到{target}分钟，奖励{reward}{name_coin}' => 'When the live streaming duration reaches {target} minutes, the reward is {reward}{name_coin}.',
    '观看视频时长达到{target}分钟，奖励{reward}{name_coin}' => 'When the video viewing duration reaches {target} minutes, the reward is {reward}{name_coin}.',
    '每天开播满足{target}小时可获得奖励{reward}{name_coin}' => 'reward {reward}{name_coin} can be obtained if the broadcast time meets {target} hours every day',
    '打赏主播超过{target}{name_coin}，奖励{reward}{name_coin}' => "reward the streamer for exceeding {target}{name_coin} ', reward {reward}{name_coin}",
    '直播间每日分享{target}次可获得奖励{reward}{name_coin}' => 'reward {reward}{name_coin} can be obtained by sharing {target} times a day in the live stream.',
    '系统繁忙,请稍后操作~' => 'System busy, please operate later ~',
    '任务未达标,请继续加油~' => 'Task not met, please keep going ~',
    '奖励已送放,明天继续加油哦~' => 'Rewards have been distributed. Keep up the good work tomorrow!',
    '动态'=>'Dynamic',
    '青少年模式'=>'Teen mode',
    '在线客服'=>'Online service',
    '更多服务'=>'More services',
    ...
    // Video
    '该视频已下架' => 'Video has been taken down',
    '请先申请广告主体认证' => 'Please apply for advertising entity certification first.',
    '非VIP用户每天可上传视频数有限' => 'Non-vip users can upload a limited number of videos per day',
    '话题标签不存在' => 'Topic tag Does not exist',
    '视频已上热门，暂时不能付费' => 'The video has gone viral and payment is not available for the time being.',
    '踩一踩成功' => 'Step on success',
    '视频信息错误,请稍后操作~' => 'Video information error. Please operate later ~',
    '你已达当天最大免费观看视频次数，无法继续观看' => 'You have reached the maximum number of free video views for the day and cannot continue watching.',
    '观看视频需要付费{coin}{name_coin}，是否确定观看' => 'Watching the video requires payment {coin}{name_coin}. Are you sure to watch it?',
    ...
    // Wxmini
    '请上传手持证件正面照' => 'Please upload a frontal photo of yourself holding your ID card',
    ...
    // functions
    '您的验证码是：{code}。请不要把验证码泄露给其他人。' => 'Your verification code is: {code}. Please do not disclose the verification code to others',
    '秒前' => 'seconds ago',
    '分钟前' => 'minutes ago',
    '天前' => 'days ago',
    '0秒' => '0 seconds',
    '你购买的“{goods_name}”订单由于超时未付款,已自动关闭' => "The order you purchased for' {goods_name} 'has been automatically closed due to overdue payment",
    '你购买的“{goods_name}”订单由于卖家超时未发货已自动关闭,货款已退还到余额账户中' => "The order {goods_name} you purchased has been automatically closed due to the seller's failure to ship within the time limit, and the payment has been refunded to the balance account.",
    '你购买的“{goods_name}”订单已自动确认收货' => "Your order '{goods_name}' has been automatically confirmed for receipt",
    '买家购买的“{goods_name}”订单佣金{commission}已自动结算到你的账户' => 'The commission {commission} for the "{goods_name}" order purchased by the buyer has been automatically settled to your account.',
    '买家购买的“{goods_name}”订单已自动结算到你的账户' => "The' {goods_name} 'order purchased by the buyer has been automatically settled to your account",
    '你申请的“{goods_name}”订单退款卖家超时未处理,已自动退款到你的余额账户中' => 'The refund for the "{goods_name}" order you applied for was overdue and not processed by the seller. It has been automatically refunded to your balance account.',
    '你购买的“{goods_name}”订单退款申请被卖家拒绝后,{shop_refund_finish_time}天内你没有进一步操作,系统自动处理结束' => 'After your refund application for the "{goods_name}" order was rejected by the seller, if you do not take further action within {shop_refund_finish_time} days, the system will automatically process it to end.',
    '剩余时间 ' => 'Remaining time ',
