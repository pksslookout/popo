...
class Domain_Live {
	...
	public function getPopularRule(){
		$rs = array();
		$model = new Model_Live();
		$rs = $model->getPopularRule();
		return $rs;
	}

	public function upPopularPeople($liveuid,$showid){
		$rs = array();
		$model = new Model_Live();
		$rs = $model->upPopularPeople($liveuid,$showid);
		return $rs;
	}
}
