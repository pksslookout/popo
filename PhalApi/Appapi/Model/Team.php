...
class Model_Team extends PhalApi_Model_NotORM {
	...
	public function getMyTeamLists($uid,$p,$isauth,$sort,$key){
        ...
        $sql = 'SELECT a.one_uid AS ouid,a.addtime,u.id,u.isauth,u.user_nicename,u.user_login,u.avatar,u.bg_img,u.avatar_thumb,u.sex,u.consumption,u.votestotal,u.team_level,u.team_count,u.agent_count,u.team_live_count,u.team_vip_count '
            . 'FROM cmf_agent AS a INNER JOIN cmf_user AS u '
            . 'ON a.uid = u.id '
