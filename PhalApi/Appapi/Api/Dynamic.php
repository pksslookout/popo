...
class Api_Dynamic extends PhalApi_Api {
	...
	public function getRules() {
		return array(
           ...
           'setComment' => array(
            ...
            'getLabelDynamicInfo'=>array(
            	'uid' => array('name' => 'uid', 'type' => 'int',  'desc' => '用户ID'),
            	'dynamic_label_id' => array('name' => 'dynamic_label_id', 'require' => true, 'type' => 'int', 'min' => 1, 'default'=>1, 'desc' => '话题标签ID'),
            ),
	...
	public function setDynamic() {
		$rs = array('code' => 0, 'msg' => T('发布成功'), 'info' => array());
...
//        }
     ...
     * @return string msg 提示信息
     */
	public function getLabelDynamicInfo() {
        $rs = array('code' => 0, 'msg' => '', 'info' => array());
        ...
        $domain = new Domain_Dynamic();
        $result = $domain->getLabelDynamicInfo($uid,$dynamic_label_id);
		if(!$result){
			$rs['code'] = 1000;
			$rs['msg'] = T("话题标签已删除");
			return $rs;
