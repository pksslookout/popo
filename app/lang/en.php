...
return array(
    // controller
    '缴纳成功' => 'Payment successful',
    '已缴纳保证金' => 'Paid Margin',
    '申请提交成功' => 'Application Submitted Successfully',
    '申请条件未达成' => 'Application conditions not met',
    '申请审核中' => 'Application under Review',
    '请上传店铺图片' => 'Please upload store pictures',
    '请输入店铺名称' => 'Please enter the store name',
    '请输入店铺简介' => 'Please enter the store introduction',
    '请上传营业执照' => 'Please upload the business license',
    '请上传许可证' => 'Please Upload license',
    '请联系管理员确认配置信息' => 'Please contact the administrator to confirm the configuration information',
    '请填写您的真实姓名' => 'Please fill in your real name.',
    '请填写您的手机号' => 'Please enter your mobile phone number',
    '请上传证件相关照片' => 'Please upload photos related to your identification document',
    '物流参数错误' => 'Logistics parameter error',
    '请填写个人姓名' => 'Please fill in your name',
    '请填写身份证号' => 'Please enter your ID number',
    '请上传身份证正面照' => 'Please upload a frontal photo of your ID card.',
    '请上传身份证背面照' => 'Please upload a photo of the back of your ID card',
    '请上传家族图标' => 'Please upload family ICONS',
    '您提交的家族申请正在审核中...' => 'The family application you submitted is under review... ',
    '家族已创建成功' => 'Family Successfully created',
    ...
    // template
    '关于短视频' => 'About Short Videos',
    '版本号' => 'Version Number',
    '用户协议' => 'User Agreement',
    '服务和隐私条款' => 'Service and Privacy Policy',
    ...
    '以下信息均为必填项，为保证您的利益，请如实填写' => 'The following information is all required fields. To ensure your interests, please fill in the blanks truthfully.',
    '正在上传中...' => 'Being uploaded...',
    '手持证件照示例' => 'Example of Handheld ID Photo',
    '请按图示手持证件拍照' => 'Please take a photo holding your ID as shown in the picture',
    '确保证件信息清晰可见' => 'Ensure that the document information is clearly visible',
    '提交认证' => 'Submit for Authentication',
    '金额:' => 'Amount:',
    '赶快去商城挑选一个吧~' => 'Hurry up and pick one from the mall ~',
    '提交反馈' => 'Submit Feedback',
    'QQ/微信/邮箱/联系电话' => 'QQ/ wechat/email/Contact Number',
    '您的联系方式有助于我们沟通改善问题，仅工作人员可见' => 'Your contact information helps us communicate and improve the issue. It is only visible to our staff',
    '请将您遇到的问题/产品建议反馈给我们。建议您尽可能详细的描述问题，便于运营童鞋帮你解决~' => 'Please give us your feedback on the problems you encounter or product suggestions. We suggest you describe the problem as detailed as possible so that the operation team can help you solve it.',
    '人看过直播' => 'People have watched live streams',
    '经验值：' => 'Experience value: ',
    '距离升级：' => 'Distance Upgrade:',
    '已达成' => 'Achieved',
    '审核通过的视频' => 'Approved video',
    '发布视频' => 'Post Video',
    '名' => 'Name',
    '粉丝数量' => 'Number of fans',
    '开启直播功能需要满足以下条件' => 'To enable the live streaming function, the following conditions must be met',
    ...
    '会员类型' => 'Member Type',
    '短视频介绍' => 'Short Video Introduction',
    '常见问题1' => 'Frequently Asked Questions 1',
    '常见问题2' => 'Frequently Asked Questions 2',
    '呼叫' => 'Call',
    '短视频官方客服电话' => 'Official customer service Hotline for Short videos',
    '短视频官方客服QQ' => 'Short Video Official Customer Service QQ',
    '家族名称：' => 'Family Name:',
    '家族抽成比例：' => 'Family Commission ratio:',
    ...
    '前往提现' => 'Go to Withdraw',
    '分享说明' => 'Share Instructions',
    '分享链接发送给好友，好友通过链接下载填写邀请码注册App后，建立上下级关系。' => 'Share the link and send it to your friends. After your friends download the link, fill in the invitation code and register the App, a superior-subordinate relationship will be established. Send the share link to your friends. After your friends download the link, fill in the invitation code and register the App, a superior-subordinate relationship will be established. ',
    '每邀请一个好友，分享人可得到agent_rewardname_votes奖励。' => 'For each friend invited, the sharer will receive agent_rewardname_votes as a reward.',
    '好友观看视频获得金币奖励，分享人可得到相应提成。' => 'Friends who watch videos receive gold coin rewards, and the sharer can get corresponding commissions. ',
    '分享赚钱' => 'Share to Make Money',
    '未达成' => 'Not reach',
    '联系方式' => 'Contact information',
    '问题反馈' => 'Problem feedback',
    '备注：' => 'Remark：',
    '反馈内容不能为空' => 'The feedback content cannot be empty',
    '联系方式不能为空' => 'The contact information cannot be left blank',
);
