...
class DynamiclabelController extends AdminbaseController {
    ...
    public function del(){
        ...
        if($id){
            $result=Db::name('dynamic_label')->delete($id);				
                if($result){
                    delete_language_translate('dynamic_label', 'name', $id);
    ...
    public function add_post(){
        if($this->request->isPost()) {
            ...
            if($result){
                insert_language_translate('dynamic_label', 'name', $result, $language);
    ...
    public function edit(){
        ...
        if($id){
            ...
            $this->assign('list_language_translate', get_language_translate('dynamic_label', 'name', $id));
    ...
    public function edit_post(){
		 ...
		 if($this->request->isPost()) {
            ...
            if($result){
                update_language_translate('dynamic_label', 'name', $id, $language);
