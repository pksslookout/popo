...
class ChargerulesController extends AdminbaseController {
	...
	function del(){
        ...
        delete_language_translate('charge_rules', 'name', $id);
        $action="删除充值规则：{$id}";
        setAdminLog($action);
    ...
    function addPost(){
		if ($this->request->isPost()) {
            ...
            insert_language_translate('charge_rules', 'name', $id, $language);
    ...
    function edit(){
        ...
        $configpub=getConfigPub();
        $this->assign('name_coin',$configpub['name_coin']);
        $this->assign('list_language_translate', get_language_translate('charge_rules', 'name', $id));
    ...
    function editPost(){
		if ($this->request->isPost()) {
            ...
            update_language_translate('charge_rules', 'name', $id, $language);
