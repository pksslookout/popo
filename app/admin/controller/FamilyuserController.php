...
class FamilyuserController extends AdminbaseController {
	...
	function index()
	{
        ...
        if($start_time!=""){
           $map[]=['fu.addtime','>=',strtotime($start_time)];
        }

        if($end_time!=""){
           $map[]=['fu.addtime','<=',strtotime($end_time) + 60*60*24];
        }
