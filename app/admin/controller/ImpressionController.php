...
class ImpressionController extends AdminbaseController {
    ...
    function del(){
        ...
        delete_language_translate('label', 'name', $id);
        $action="删除印象标签：{$id}";
        setAdminLog($action);
    ...
    function addPost(){
		if ($this->request->isPost()) {
            ...
            insert_language_translate('label', 'name', $id, $language);
	...
	function edit(){
        ...
        $this->assign('list_language_translate', get_language_translate('label', 'name', $id));
    ...
    function editPost(){
		if ($this->request->isPost()) {
            ...
            $id=$data['id'];
            update_language_translate('label', 'name', $id, $language);
