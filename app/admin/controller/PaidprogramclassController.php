...
class PaidprogramclassController extends AdminbaseController {
    ...
    function class_del(){
        ...
        delete_language_translate('paidprogram_class', 'name', $id);
        $this->resetcache();
    ...
    function class_add_post(){
        if ($this->request->isPost()) {
            ...
            insert_language_translate('paidprogram_class', 'name', $id, $language);
    ...
    function class_edit(){
        ...
        $this->assign('list_language_translate', get_language_translate('paidprogram_class', 'name', $id));
        $this->assign('status',$this->getStatus());
    ...
    function class_edit_post(){
        if ($this->request->isPost()){
            ...
            update_language_translate('paidprogram_class', 'name', $id, $language);
