...
//            }
            ...
            if($options['video_watermark'] !=$oldconfigpri['video_watermark']){
                ...
                $region = $oldconfigpri['qcloud_region'];
                $bucket = $oldconfigpri['qcloud_bucket'];
                ...
                try {
                    ...
                    $name = explode('/', $options['video_watermark']);
                    $name = explode('.', $name[2]);
                    $result = $cosClient->CreateWatermarkTemplate(array(
                        ...
                        // 水印信息;是否必传：否
                        'Watermark'=> array(
                            'Type'=> 'Image', // 水印类型Text：文字水印Image：图片水印;是否必传：是
                            ...
                            'Image' => array(
                                'Url' => get_upload_path($options['video_watermark']),
                                'Mode' => 'Original',
                                'Width' => 'Original',
                                'Height' => 'Original',
                                'Transparency' => '90',
                    ...
                    // 请求成功
                    $options['video_watermark_template_id'] = $result['Template']['TemplateId'];
